...
describe("Parse 64-bit unsigned integer", () => {
  ...
  describe("big-endian", () => {
    ...
    it("should decode", () => {
      ...
      assert.equal(Token.UINT64_BE.get(buf, 0), BigInt(0x00001a001a001a01));
      assert.equal(Token.UINT64_BE.get(buf, 8), BigInt(0x00001a001a001a02));
    });
  ...
  describe("litle-endian", () => {
    ...
    it("should decode", () => {
      ...
      it("little-endian", () => {
        assert.equal(Token.UINT64_LE.get(buf, 0), BigInt(0x001a001a));
        assert.equal(Token.UINT64_LE.get(buf, 8), BigInt(0x001a001a));
      });
